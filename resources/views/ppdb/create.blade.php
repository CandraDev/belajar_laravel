        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('ppdb.store') }}" method="post" enctype="multipart/form-data" class="p-3">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="alamat" rows="3" name="alamat"
                                    placeholder="Masukan alamat terkini siswa..."></textarea>
                                @error('alamat')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="phone" class="form-control" id="asal_sekolah" name="asal_sekolah"
                                    placeholder="Masukan asal sekolah siswa...  ">
                                @error('asal_sekolah')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
